...
public record OrderDetailModel : IWithId
{
    ...
    public OrderDetailModel(Guid id, string name, string description, string address, DateTime createdDate, DateTime deliveryTime, Guid restaurantId, string restaurantName, OrderState orderState)
    {
        Id = id;
        Name = name;
